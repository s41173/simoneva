            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Rekening', dataField: 'Rekening', width : 350 },
  				  { text: 'Sumber Dana', dataField: 'Sumber Dana', width : 150 },
                  { text: 'Jumlah', datafield: 'Jumlah', width: 150, cellsalign: 'right', cellsformat: 'number' },
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:530px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Laporan Pagu </h4>
	   </div>
	</center>
...
<!--        protected $field = array('id', 'parent_id', 'category', 'code', 'name', 'description', 'publish', 'created', 'updated', 'deleted');-->
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> DPPA </th> <th> Program </th> <th> Rekening </th> <th> Sumber Dana </th> <th> Jumlah </th>
           <th> Tahun </th>
		   </tr>
           </thead>
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\">".account($res->account_id)."</td>
   					   <td class=\"strongs\">".$res->source."</td> 
