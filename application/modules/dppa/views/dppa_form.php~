...
<div class="modal-header">
  ...
  <h4 class="modal-title"> Add New DPPA </h4>
</div>
...
<form id="upload_form" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action; ?>" 
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="tcode" class="form-control col-md-7 col-xs-12" type="text" name="tcode" required placeholder="Code">
      </div>
    </div> 
    ...
    <div class="form-group">
      ...
      <div class="form-group">
       <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12"> Bendahara </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="tbendahara" class="form-control col-md-6 col-xs-12" type="text" name="tbendahara" placeholder="Bendahara">
        <input id="tbendahara_nip" class="form-control col-md-6 col-xs-12" type="text" name="tbendahara_nip" placeholder="NIP Bendahara">
        </div>        
      </div>
      ...
      <div class="form-group">
       <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12"> Kadis </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="tkadis" class="form-control col-md-6 col-xs-12" type="text" name="tkadis" placeholder="Kadis">
        <input id="tkadis_nip" class="form-control col-md-6 col-xs-12" type="text" name="tkadis_nip" placeholder="NIP Kadis">
        </div>        
      </div>
