...
<script src="<?php echo base_url(); ?>js/moduljs/dppa.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('dppa/add_process/');?>";
	var sites_edit = "<?php echo site_url('dppa/update_process/');?>";
    ...
    var sites_procurement = "<?php echo site_url('procurement/get_dppa/');?>";
 ...
 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal3"> Progress Report  </button>
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('dppa_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Edit Form -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('dppa_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
