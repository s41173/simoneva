...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:530px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Kode Dan Daftar Program Dan Kegiatan <br> 
               Menurut Urusan Pemerintahan Daerah </h4>
	   </div>
	</center>
...
<!--        protected $field = array('id', 'parent_id', 'category', 'code', 'name', 'description', 'publish', 'created', 'updated', 'deleted');-->
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> DPPA </th> <th> Kode </th> <th> Nama </th> <th> Keterangan </th>
		   </tr>
           </thead>
        ...
        <a style="float:left; margin:10px;" title="Back" href="<?php echo site_url('acategory'); ?>"> 
